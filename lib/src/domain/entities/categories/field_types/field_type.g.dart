...
_$StringFieldType _$_$StringFieldTypeFromJson(Map<String, dynamic> json) {
  return _$StringFieldType(
    nulleable: json['nulleable'] as bool? ?? false,
  );
}

Map<String, dynamic> _$_$StringFieldTypeToJson(_$StringFieldType instance) =>
    <String, dynamic>{
      'nulleable': instance.nulleable,
    };
