...
import 'package:latlong2/latlong.dart' as _i63;
...
import 'src/domain/services/location_reader_service.dart' as _i66;
import 'src/domain/services/map_conf_reader_service.dart' as _i67;
import 'src/domain/services/map_conf_writter_service.dart' as _i68;
...
import 'src/infrastructure/repositories/configuration_repository.dart' as _i65;
...
import 'src/presentation/pages/geodata/blocs/geodataview/geodataview_cubit.dart'
    as _i13;
import 'src/presentation/pages/home/blocs/location/location_cubit.dart' as _i69;
import 'src/presentation/pages/home/blocs/map/map_cubit.dart' as _i62;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.CategoryCreateFormBloc>(() => _i8.CategoryCreateFormBloc(
  ...
  gh.lazySingleton<_i18.ICategoryService>(
      () => _i19.CategoriesService(get<_i16.ICategoriesRepository>()));
  gh.lazySingleton<_i20.IColumnRepository>(
      () => _i21.ColumnRepository(provider: get<_i14.IColumnsProvider>()));
  ...
  gh.lazySingleton<_i31.IFieldTypeRepository>(
      () => _i32.FieldTypeRepository(provider: get<_i14.IFieldTypeProvider>()));
  ...
  gh.lazySingleton<_i41.IFieldValueRepository>(() =>
      _i42.FieldValueRepository(provider: get<_i14.IFieldValueProvider>()));
  ...
  gh.lazySingleton<_i18.IGeodataFiltersOptionsService>(
      () => _i47.GeodataFilterService(get<_i16.IGeodataFilterRepository>()));
  gh.lazySingleton<_i14.IGeodataProvider>(() => _i48.GeodataSQLiteProvider());
  gh.factory<_i16.IGeodataRepository>(
      () => _i49.GeodataRepository(provider: get<_i14.IGeodataProvider>()));
  gh.lazySingleton<_i18.IGeodataService>(
      () => _i50.GeodataService(get<_i16.IGeodataRepository>()));
  ...
  gh.lazySingleton<_i16.ILocationRepository>(
      () => _i55.LocationRepository(get<_i14.ILocationProvider>()));
  gh.lazySingleton<_i18.IMapFiltersOptionsService>(
      () => _i56.MapFiltersService(get<_i16.IMapFilterRepository>()));
  gh.lazySingleton<_i18.IMarkerGetterService>(
      () => _i57.GetMarkers(get<_i16.IGeodataRepository>()));
  ...
  gh.factory<_i61.MapConfigurationInputCubit>(() =>
      _i61.MapConfigurationInputCubit(
          readerService: get<_i6.IMapConfigurationReaderService>(),
          writterService: get<_i6.IMapConfigurationWritterService>()));
  gh.factoryParam<_i62.MapCubit, _i63.LatLng?, dynamic>((initialLocation, _) =>
      _i62.MapCubit(
          confReader: get<_i6.IMapConfigurationReaderService>(),
          initialLocation: initialLocation));
  gh.factory<_i64.MarkerCubit>(() =>
      _i64.MarkerCubit(markerGetterService: get<_i18.IMarkerGetterService>()));
  gh.factory<_i16.IConfigurationRepository>(() =>
      _i65.ConfigurationRepository(get<_i51.ILocalPreferencesProvider>()));
  gh.lazySingleton<_i6.ILocationReaderService>(() => _i66.LocationReaderService(
      get<_i16.IConfigurationRepository>(), get<_i16.ILocationRepository>()));
  gh.lazySingleton<_i18.IMapConfigurationReaderService>(() =>
      _i67.MapConfigurationReaderService(get<_i16.IConfigurationRepository>()));
  gh.lazySingleton<_i18.IMapConfigurationWritterService>(() =>
      _i68.MapConfigurationWritterService(
          get<_i16.IConfigurationRepository>()));
  gh.factory<_i69.LocationCubit>(() => _i69.LocationCubit(
