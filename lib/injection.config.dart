...
import 'src/domain/repositories/i_configuration_repository.dart' as _i27;
import 'src/domain/repositories/i_geodata_repostitory.dart' as _i25;
...
import 'src/domain/services/map/location_reader_service.dart' as _i30;
...
import 'src/presentation/views/home/blocs/location/location_cubit.dart' as _i31;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i5.ILocationRepository>(
      () => _i17.LocationRepository(get<_i18.ILocationProvider>()));
  gh.lazySingleton<_i7.IMapFiltersOptionsService>(
      () => _i19.MapFiltersService(get<_i5.IMapFilterRepository>()));
  ...
  gh.lazySingleton<_i7.IMarkerGetterService>(
      () => _i24.GetMarkers(get<_i25.IGeoDataRepository>()));
  gh.lazySingleton<_i7.IUserPreferencesReaderService>(() =>
      _i26.UserPreferencesReaderService(get<_i27.IConfigurationRepository>()));
  gh.lazySingleton<_i7.IUserPreferencesWritterService>(() =>
      _i28.UserPreferencesWritterService(get<_i27.IConfigurationRepository>()));
  gh.factory<_i29.MapCubit>(() => _i29.MapCubit(
      sourceConfReader: get<_i7.IMapSourceConfigurationReaderService>()));
  gh.lazySingleton<_i7.ILocationReaderService>(() => _i30.LocationReaderService(
      get<_i5.IConfigurationRepository>(), get<_i5.ILocationRepository>()));
  gh.factory<_i31.LocationCubit>(() => _i31.LocationCubit(
