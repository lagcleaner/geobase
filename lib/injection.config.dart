...
import 'src/domain/repositories/i_configuration_repository.dart' as _i35;
import 'src/domain/repositories/i_geodata_repostitory.dart' as _i33;
...
import 'src/domain/services/configurations/user_preferences_writter_service.dart'
    as _i36;
import 'src/domain/services/geodata/geodata_filter_service.dart' as _i20;
import 'src/domain/services/geodata/goedata_service.dart' as _i22;
import 'src/domain/services/geodata/interfaces/i_geodata.dart' as _i21;
import 'src/domain/services/map/filters_service.dart' as _i27;
import 'src/domain/services/map/interfaces/i_location_reader.dart' as _i9;
import 'src/domain/services/map/location_reader_service.dart' as _i44;
import 'src/domain/services/map/markers_service.dart' as _i32;
import 'src/domain/services/services.dart' as _i11;
import 'src/infrastructure/providers/interfaces/i_location_provider.dart'
    as _i23;
import 'src/infrastructure/providers/interfaces/interfaces.dart' as _i26;
import 'src/infrastructure/providers/location_provider.dart' as _i24;
...
import 'src/infrastructure/repositories/location_repository.dart' as _i25;
...
import 'src/presentation/pages/geodata/blocs/geodata_create/geodata_create_cubit.dart'
    as _i8;
import 'src/presentation/pages/geodata/blocs/geodata_create_form/geodatacreate_form_bloc.dart'
    as _i19;
...
import 'src/presentation/pages/geodata/blocs/geodataview/geodataview_cubit.dart'
    as _i42;
import 'src/presentation/pages/home/blocs/location/location_cubit.dart' as _i45;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i19.IGeodataCreateFormBloc, _i8.GeodataCreateInitialData?,
          dynamic>(
  ...
  gh.lazySingleton<_i11.IGeodataFiltersOptionsService>(
      () => _i20.GeodataFilterService(get<_i12.IGeoDataFilterRepository>()));
  gh.lazySingleton<_i21.IGeodataService>(
      () => _i22.GeoDataService(get<_i12.IGeoDataRepository>()));
  gh.lazySingleton<_i23.ILocationProvider>(() => _i24.LocationProvider());
  gh.factory<_i12.ILocationRepository>(
      () => _i25.LocationRepository(get<_i26.ILocationProvider>()));
  gh.lazySingleton<_i11.IMapFiltersOptionsService>(
      () => _i27.MapFiltersService(get<_i12.IMapFilterRepository>()));
  gh.lazySingleton<_i28.IMapSourceConfigurationReaderService>(() =>
      _i29.MapSourceConfigurationReaderService(
          get<_i12.IConfigurationRepository>()));
  gh.lazySingleton<_i30.IMapSourceConfigurationWritterService>(() =>
      _i31.MapSourceConfigurationWritterService(
          get<_i12.IConfigurationRepository>()));
  gh.lazySingleton<_i11.IMarkerGetterService>(
      () => _i32.GetMarkers(get<_i33.IGeoDataRepository>()));
  gh.lazySingleton<_i11.IUserPreferencesReaderService>(() =>
      _i34.UserPreferencesReaderService(get<_i35.IConfigurationRepository>()));
  gh.lazySingleton<_i11.IUserPreferencesWritterService>(() =>
      _i36.UserPreferencesWritterService(get<_i35.IConfigurationRepository>()));
  gh.factoryParam<_i37.MapCubit, _i38.LatLng?, dynamic>((initialLocation, _) =>
      _i37.MapCubit(
          sourceConfReader: get<_i11.IMapSourceConfigurationReaderService>(),
          initialLocation: initialLocation));
  gh.factory<_i39.RelationsCubit>(
      () => _i39.RelationsCubit(get<_i6.ICategoryService>()));
  gh.factory<_i40.CategoriesBloc>(
      () => _i40.CategoriesBloc(get<_i11.ICategoryService>()));
  gh.factory<_i41.CategoryViewCubit>(
      () => _i41.CategoryViewCubit(get<_i11.ICategoryService>()));
  gh.factory<_i42.GeodataViewCubit>(
      () => _i42.GeodataViewCubit(get<_i21.IGeodataService>()));
  gh.factory<_i43.ICategoryCreateFormBloc>(() => _i43.CategoryCreateFormBloc(
      categoryService: get<_i11.ICategoryService>()));
  gh.lazySingleton<_i11.ILocationReaderService>(() =>
      _i44.LocationReaderService(get<_i12.IConfigurationRepository>(),
          get<_i12.ILocationRepository>()));
  gh.factory<_i45.LocationCubit>(() => _i45.LocationCubit(
